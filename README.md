...
This is the latest version of my [homepage](https://hui-po-wang.github.io/)'s source code. Feel free to use and share.
<br />
...
https://github.com/hui-po-wang/hui-po-wang.github.io/blob/2b9837cd9a6ae6b485906a351c7b2f5a06d45ece/google_scholar_crawler/main.py#L7


### Acknowledgements

This project is built upon [Yaoyao Liu's repo](https://github.com/yaoyao-liu/yaoyao-liu.github.io?tab=readme-ov-file) and uses the source code from the following repositories:
